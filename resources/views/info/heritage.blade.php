           ...
           <div class="panel panel-default">
             <div class="panel-body">
               <div class="blog-post-content">
                 <h2 class="blog-post-title">{{$heritage->name}}</h2>
                 ...
                 <div class="row">
                   <div class="col-md-4">
                     <ul>
                       <li><h3>Location:</h3><p>{{$heritage->location}}</p></li>
                       <li><h3>Open till:</h3><p>{{$heritage->open_hours}}</p></li>
                       <li><h3>Things to do:</h3><p>{{$heritage->things_to_do}}</p></li>
                       <li><h3>Climate:</h3><p>{{$heritage->climate}}</p></li>
                       <li><h3>Best Season:</h3><p>{{$heritage->best_season}}</p></li>
                     </ul>
                   </div>
