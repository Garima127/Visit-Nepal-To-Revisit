...
-->
  ...
  <link href="accountcss/font-awesome.min.css" rel="stylesheet">
  <link href="accountcss/bootstrap.min.css" rel="stylesheet">
  <link href="accountcss/bootstrap-datetimepicker.min.css" rel="stylesheet">  
  <link href="accountcss/flexslider.css" rel="stylesheet">
  <link href="accountcss/templatemo-style.css" rel="stylesheet">
  ...
  <body class="tm-gray-bg">
  		...
  		<div class="container">
  			<div class="row">
  				<div class="col-lg-6 col-md-4 col-sm-3 tm-site-name-container">
  					<a href="#" class="tm-site-name">The Old House</a>	
  				</div>
	...
	<script type="text/javascript" src="jsacc/jquery-1.11.2.min.js"></script>      		
  	<script type="text/javascript" src="jsacc/moment.js"></script>							
	<script type="text/javascript" src="jsacc/bootstrap.min.js"></script>					
	<script type="text/javascript" src="jsacc/bootstrap-datetimepicker.min.js"></script>	
	<script type="text/javascript" src="jsacc/jquery.flexslider-min.js"></script>

   	<script type="text/javascript" src="jsacc/templatemo-script.js"></script>      		
	<script>
